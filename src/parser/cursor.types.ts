...
export class SQXCursorDetails
{
    ...
    public property:SQXPropertyRef      =   null;       //  If the selected token IS, or is related to, a property reference (even one that is incomplete and requires suggestions), this will point to it
